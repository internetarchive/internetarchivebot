 ...
 * @copyright Copyright (c) 2015-2017, Maximilian Doerr
 */
class zhwikiParser extends Parser {
    ...
    protected function rescueLink( &$link, &$modifiedLinks, &$temp, $tid, $id ) {
        ...
        if( $link['link_type'] == "link" || $link['link_type'] == "stray" ) {
            ...
            if( trim( $link['link_string'], " []" ) == $link['url'] || $link['link_type'] == "stray" ) {
                ...
                else $link['newdata']['link_template']['parameters']['title'] = "存档副本";
    ...
    protected function generateNewCitationTemplate( &$link, &$temp ) {
        ...
        if( ( $link['tagged_dead'] === true || $link['is_dead'] === true ) ) {
            if( !isset( $link['link_template']['parameters']['dead-url'] ) && !isset( $link['link_template']['parameters']['offline'] ) )
                $link['newdata']['link_template']['parameters']['deadurl'] = "yes";
            elseif( isset( $link['link_template']['parameters']['offline'] ) ) $link['newdata']['link_template']['parameters']['offline'] = "yes";
            else $link['newdata']['link_template']['parameters']['dead-url'] = "yes";
        } else {
            if( !isset( $link['link_template']['parameters']['dead-url'] ) && !isset( $link['link_template']['parameters']['offline'] ) )
                $link['newdata']['link_template']['parameters']['deadurl'] = "no";
            elseif( isset( $link['link_template']['parameters']['offline'] ) ) $link['newdata']['link_template']['parameters']['offline'] = "no";
            else $link['newdata']['link_template']['parameters']['dead-url'] = "no";
        }
        //Set the archive URL
        if( isset( $link['link_template']['parameters']['datum'] ) ||
            isset( $link['link_template']['parameters']['zugriff'] ) ||
            isset( $link['newdata']['link_template']['parameters']['zugriff'] ) ||
            isset( $link['link_template']['parameters']['archiv-url'] ) ||
            isset( $link['link_template']['parameters']['titel'] ) ||
            isset( $link['link_template']['parameters']['autor'] ) ||
            isset( $link['link_template']['parameters']['sprache'] ) ||
            isset( $link['link_template']['parameters']['seiten'] ) ||
            isset( $link['link_template']['parameters']['zitat'] ) ||
            isset( $link['link_template']['parameters']['kommentar'] ) ||
            isset( $link['link_template']['parameters']['titelerg'] ) ||
            isset( $link['link_template']['parameters']['werk'] ) ||
            isset( $link['link_template']['parameters']['hrsg'] )
        ) $link['newdata']['link_template']['parameters']['archiv-url'] = $temp['archive_url'];
        elseif( !isset( $link['link_template']['parameters']['archive-url'] ) && !isset( $link['link_template']['parameters']['archive-url'] ) )
        ...
        if( isset( $link['link_template']['parameters']['datum'] ) ||
            ...
            isset( $link['link_template']['parameters']['werk'] ) ||
            isset( $link['link_template']['parameters']['hrsg'] )
        ) $link['newdata']['link_template']['parameters']['archiv-datum'] = $temp['archive_time'];
        elseif( !isset( $link['link_template']['parameters']['archive-date'] ) ) {
    ...
    protected function analyzeCitation( &$returnArray, &$params ) {
        ...
        if( !empty( $returnArray['link_template']['parameters']['accessdate'] ) ) {
        ...
        } elseif( !empty( $returnArray['link_template']['parameters']['access-date'] ) ) {
            ...
            if( $time === false ) $time = "x";
            $returnArray['access_time'] = $time;
        } elseif( !empty( $returnArray['link_template']['parameters']['zugriff'] ) ) {
            $time = self::strtotime( $returnArray['link_template']['parameters']['zugriff'] );
            if( $time === false ) $time =
                self::strtotime( API::resolveWikitext( $returnArray['link_template']['parameters']['zugriff'] ) );
            if( $time === false ) $time = "x";
            $returnArray['access_time'] = $time;
        ...
        if( !empty( $returnArray['link_template']['parameters']['archive-url'] ) )
            $returnArray['archive_url'] = $this->filterText( htmlspecialchars_decode( $returnArray['link_template']['parameters']['archive-url'] ) );
        if( !empty( $returnArray['link_template']['parameters']['archiv-url'] ) )
            $returnArray['archive_url'] = $this->filterText( htmlspecialchars_decode( $returnArray['link_template']['parameters']['archiv-url'] ) );
        if( ( !empty( $returnArray['link_template']['parameters']['archiveurl'] ) || !empty( $returnArray['link_template']['parameters']['archive-url'] ) || !empty( $returnArray['link_template']['parameters']['archiv-url'] ) ) &&
        ...
        if( ( isset( $returnArray['link_template']['parameters']['deadurl'] ) &&
            ...
            ( isset( $returnArray['link_template']['parameters']['offline'] ) &&
                $returnArray['link_template']['parameters']['offline'] == "yes" )
        ) {
            ...
            ( isset( $returnArray['link_template']['parameters']['offline'] ) &&
                $returnArray['link_template']['parameters']['offline'] == "no" )
        ) {
        ...
        if( API::isArchive( $returnArray['original_url'], $returnArray ) ) {
            ...
            if( !isset( $returnArray['link_template']['parameters']['accessdate'] ) &&
                ...
                !isset( $returnArray['link_template']['parameters']['zugriff'] ) &&
